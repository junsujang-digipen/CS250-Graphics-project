...
{
	EP::Shader::MakeShaderHandle("Default");
	EP::Shader::CompileShader("Default", GL_VERTEX_SHADER, "../shaders/3Dmodel.vert");
	EP::Shader::CompileShader("Default", GL_FRAGMENT_SHADER, "../shaders/3Dmodel.frag");
	EP::Shader::LinkingShader("Default");
	
	//EP::Shader::LinkingShader("GeoShader");

	object = new Entity("anthing");
	object->SetShader(EP::Shader::GetShader("Default"));
...
void TestScene::ImguiUpdate(double /*dt*/)
{	
